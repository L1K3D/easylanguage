...
public class EasyLanguageLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INT", "BOOLEANO", "FUNC", "PROC", "RETURN", "WRITE", "ENQUANTO", "FACA", 
			"PARA", "DE", "ATE", "PASSO", "FIM", "VERDADEIRO", "FALSO", "E", "OU", 
			"NAO", "PLUS", "MINUS", "MUL", "DIV", "MENOR", "MAIOR", "IGUAL", "DIFERENTE", 
			"ID", "NUMBER", "SEMI", "EQ", "LPAREN", "RPAREN", "ABRECOL", "FECHACOL", 
			"COMMA", "COLON", "WS"
		};
	}
